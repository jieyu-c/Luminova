package cn.jieyuc.luminova.lock.annotation;

import cn.jieyuc.luminova.lock.logic.DistributeLockConstant;
...
public @interface DistributeLock {
     ...
     * @return
     */
    String keyExp() default DistributeLockConstant.NONE_KEY;
